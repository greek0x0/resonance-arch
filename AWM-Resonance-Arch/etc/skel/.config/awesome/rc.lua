...
--run_once({ "picom &", "unclutter -root", "xfsettingsd --replace --no-daemon",
--"lxsession",}) -- comma-separated entries
awful.spawn.with_shell('pkill -f indefinite-picom')
--hotkeys
...
awful.spawn.with_shell('bash /home/$USER/.config/awesome/current_theme/theme.sh')
--awful.spawn.with_shell('feh --bg-scale /home/$USER/Documents/unknown.png')
...
globalkeys = mytable.join(
    ...
    --BROWSER
    awful.key({ modkey }, "q", function () awful.spawn.with_shell("bash ~/.config/rofi/bin/powermenu") end,
...
--Launch alt-space
   ...
   awful.key({ modkey }, "d", function () awful.spawn.with_shell("bash ~/.config/rofi/bin/launcher") end,
   --Network modkey n
              {description = "Applications", group = "launcher"}),
   ...
   awful.key({ altkey }, "space", function () awful.spawn.with_shell("bash ~/.config/rofi/bin/launcher") end,
              {description = "Applications", group = "launcher"}),
